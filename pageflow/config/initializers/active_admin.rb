ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Self Hosted Pageflow"
  ...
  #
  # Load Pageflow admin resources from gem
  config.load_paths << Pageflow.active_admin_load_path
  ...
  # Apply Pageflow-specific ActiveAdmin settings
